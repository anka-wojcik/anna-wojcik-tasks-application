...
public class TrelloFacadeTest {
    ...
    public void testCreateCard() {
        ...
        TrelloCard trelloCard = new TrelloCard("Card no. 1", "Description no. 1", "top", "1");
        ...
        assertEquals("Card no. 1", createdTrelloCardDto1.getName());
        assertEquals("https://testing.com", createdTrelloCardDto1.getShortUrl());
    }
}
